/* Перенесемся на задачу во вселенную Ведьмака, а именно в игру Гвинт. 
...
namespace Example_Task_01
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Получив результаты, уберите из определения класса Skellige модификаторы virtual и вновь запустите приложение. Объясните и исправьте ошибки.
