 ...
 * В файле записано 10^9 целых чисел из диапазона [-10.000.000;10.000.000]
 ...
 * TODO: 4 L R -- записать в файл значения с интервала [L;R] (notice: тут нет необходимости искуственно уменьшать интервал!)
 *
